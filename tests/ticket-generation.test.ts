    ...
    await fc.assert(
      fc.asyncProperty(
        fc.record({
          ...
          flightNumber: fc.option(fc.string({ minLength: 1, maxLength: 10 }), { nil: undefined }),
          trackUrl: fc.webUrl(),
          serviceType: fc.option(fc.constantFrom('drop_off', 'pick_up'), { nil: undefined }),
          terminalCode: fc.option(fc.constantFrom('1A', '1B', '1C', '2E', '2F', '3'), { nil: undefined }),
          meetingPointLocation: fc.option(unicodeStringGen, { nil: undefined }),
          arrivalTimeOffsetMin: fc.option(fc.integer({ min: 15, max: 45 }), { nil: undefined }),
          arrivalTimeOffsetMax: fc.option(fc.integer({ min: 20, max: 50 }), { nil: undefined }),
        }),
        async (payload) => {
