-- Ensure bookings has room_number column
alter table public.bookings
  add column if not exists room_number text;

-- Refresh booking_details view to expose room_number
...
comment on view public.booking_details is 'Aggregated booking information for ticket tracking, including room number.';
